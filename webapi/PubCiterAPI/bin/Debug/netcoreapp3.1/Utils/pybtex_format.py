...
def convert(input_format, output_format, data):
    ...
    os.system('pybtex-format input.' + input_format +
...
def main(argv):
    try:
        ...
        sys.exit(
            'Usage: $> pybtex_format.py [--h] --input-format <format> --output-format <format> --data <input string>')

    if (len(opts) != 3):
        sys.exit(
            'ERROR: Usage: $> pybtex_format.py [--h] --input-format <format> --output-format <format> --data <input string>')
