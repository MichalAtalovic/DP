...
class ProxyGenerator(object):
    ...
    def _get_webdriver(self):
        ...
        if self._proxy_works:
            # Redirect webdriver through proxys
        ...
        print('CONFIG')
        print(operaConfig['operaProfileDir'])
        print(operaConfig['operaDriverExecutablePath'])

        options = webdriver.ChromeOptions() 
        options.add_argument("--user-data-dir=" + operaConfig['operaProfileDir'])
        self._webdriver = webdriver.Opera(executable_path=operaConfig['operaDriverExecutablePath'], options=options)
