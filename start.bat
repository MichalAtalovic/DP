...
REM serve client application (install missing node modules if needed)
start cmd /k "cd client/pubciter && echo Installing missing node modules . . . && npm install && echo Deploying . . . && ng serve --host 0.0.0.0 --disableHostCheck"